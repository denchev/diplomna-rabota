...
CACHE_PATH = Path(__file__).resolve().parent / 'article_sentiment_claude_cache.json'
...
output_df.to_csv('output/svobodno_vreme/dnes_bg_with_news_data_claude.csv', encoding='utf-8-sig', index_label='comment_text') 